...
<div id="header"><h1><a href="admin-home.php" style="text-decoration: none;color: white;">INVENTORY MANAGEMENT SYSTEM</a></h1></div>
		...
		?>
		<h3><b>OUT STOCK ORDER LIST</b></h3>
		<center><div id="form">
			<table><tr>
					<td><center><b><font color="blue">Customer Name</font></b></center></td>
					<td><center><b><font color="blue">Mobile No</font></b></center></td>
					<td><center><b><font color="blue">Order</font></b></center></td>
					</tr>
				<?php
